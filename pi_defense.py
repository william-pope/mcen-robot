...
#       - v_mL: green marker horizontal position [px] (camera frame)    ISSUE: pink/green markers won't be present when on defense
...
def defense():
    ...
    while k_step < 1:
        ...
        if mode_k == 0:
            mode_k1, rpm_k1 = operate_m0(obs_k)
        elif mode_k == 1:
            mode_k1, rpm_k1 = operate_m1(obs_k)
